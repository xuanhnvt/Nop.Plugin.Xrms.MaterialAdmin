...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class MaterialController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(MaterialModel model, bool continueEditing)
        {
            ...
            foreach (var item in list)
                viewModel.AvailableMaterialGroups.Add(item);
        ...
        public virtual IActionResult Edit(int id)
        {
            ...
            var model = material.ToDetailsViewModel();
            ...
            */
            ...
            return View("~/Plugins/Xrms.MaterialAdmin/Areas/Admin/Views/Material/Edit.cshtml", model);
        }
